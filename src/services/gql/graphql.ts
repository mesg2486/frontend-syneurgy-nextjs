...
export type ListMeetingsByUserIdQuery = { __typename?: 'Query', meetings?: { __typename?: 'MeetingConnection', items?: Array<{ __typename?: 'Meeting', date: string, highlights?: string | null, id: string, name: string, createdAt: string, updatedAt: string, sentiment?: string | null, performance?: string | null, synchrony?: string | null, teamId: string, thumbnail?: string | null, type: string, url: string, userId: string } | null> | null } | null };
